            ...
            <div class="form-group">
                ...
                <input type="date" name="tanggal_pencatatan" class="form-control" placeholder="Tanggal Pencatatan">
                <?php if($errors->has('tanggal_pencatatan')): ?>
                    <span class="text-danger"><?php echo e($errors->first('tanggal_pencatatan')); ?></span>
                <?php endif; ?>
            </div><?php /**PATH C:\xampp\htdocs\uas_pdb\resources\views/Kartu_keluarga/_form.blade.php ENDPATH**/ ?>